...
/**
 * Ordered small → large, then Custom. People reach for the one that matches
 * what is in their hand, so the row is scanned by size rather than frequency.
 */
export const VESSELS: readonly Vessel[] = [
  { key: 'glass', ounces: 8, label: '+8 oz', name: 'Small glass', icon: 'cup' },
  { key: 'mug', ounces: 12, label: '+12 oz', name: 'Mug', icon: 'coffee' },
  { key: 'bottle', ounces: 16, label: '+16 oz', name: 'Bottle', icon: 'bottle' },
  { key: 'shaker', ounces: 24, label: '+24 oz', name: 'Shaker', icon: 'flask' },
  { key: 'sports', ounces: 34, label: '+34 oz', name: 'Sports bottle', icon: 'bottle' },
  { key: 'tumbler', ounces: 40, label: '+40 oz', name: 'Tumbler', icon: 'cup' },
  { key: 'custom', ounces: null, label: 'Custom', name: 'Type it', icon: 'pencil-outline' },
];
