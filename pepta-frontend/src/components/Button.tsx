...
export function Button({
  ...
  const pressIn = () =>
    Animated.spring(scale, { toValue: theme.motion.scale.pressIn, useNativeDriver: true, ...theme.motion.springs.press }).start();
  const pressOut = () =>
    Animated.spring(scale, { toValue: theme.motion.scale.pressOut, useNativeDriver: true, ...theme.motion.springs.press }).start();
  ...
  const labelColor =
    variant === 'primary' ? 'onPrimary' : variant === 'secondary' ? 'textPrimary' : 'primary';
